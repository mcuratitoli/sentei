...
- 🗺️ **Difficoltà del sentiero visibile sulla linea del tracciato.** Come
  ...
  **piena** per i tratti turistici (T), **a trattini** per gli
  ...
  tracciato non cambia. Trattini e pallini sono ora **più radi e marcati** e
  senza bordo bianco (prima "impastava" il tratteggio e la linea sembrava
  solo sfumata). La legenda "Difficoltà dei percorsi" mostra il campione di
  ogni linea.
