...
- **Step 6b — download aree offline (ELEVAZIONE)** — cachare le tile **Terrarium** dell'area per avere D+/profilo offline (oggi `TerrariumElevationService` scarica online). Prossimo.
